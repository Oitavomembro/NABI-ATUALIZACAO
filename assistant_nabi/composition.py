...
def _compose_read_only_service(
    *,
    ...
    registry.register(PRODUCT_SEARCH, ProductSearchTool(queries))
    registry.register(PRODUCT_STOCK, ProductStockTool(queries))
    registry.register(CUSTOMER_SEARCH, CustomerSearchTool(queries))
