...
class DraftConfirmationService:
    ...
    def issue(self, draft, *, actor: AssistantActor) -> ConfirmationChallenge:
        ...
        challenge = ConfirmationChallenge(
            ...
            required_capability=(
                ...
                if draft.operation_kind in {"PURCHASE_RECEIPT", "NFE_ENTRY_IMPORT", "CUSTOMER_CREATE", "CUSTOMER_RECEIPT", "PRODUCT_CREATE", "STOCK_RECEIVE", "STOCK_REMOVE", "STOCK_ADJUST"}
    ...
    def consume(self, grant, *, draft, operation: str, actor=None) -> _GrantRecord:
        ...
        required = (
            CapabilityLevel.REINFORCED_CONFIRMATION
            if operation in {"PURCHASE_RECEIPT", "NFE_ENTRY_IMPORT", "CUSTOMER_CREATE", "CUSTOMER_RECEIPT", "PRODUCT_CREATE", "STOCK_RECEIVE", "STOCK_REMOVE", "STOCK_ADJUST"}
            else CapabilityLevel.SIMPLE_CONFIRMATION
        )
