...
- [~] Fase 2: núcleo imutável no checkpoint `1d9b092` e exposição tipada ao modelo/painel no checkpoint `e775982`; transferência ao PDV e confirmação vinculada ainda estão pendentes;
