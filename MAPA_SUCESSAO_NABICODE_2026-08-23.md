...
- [~] Fase 0: modelo de ameaças, níveis, schemas fechados, registro fail-closed, sessão/permissões, auditoria e primeiras ferramentas comerciais somente leitura implementados na branch `codex/ia-nabi-fase0`; orquestração textual e provedor local aberto ainda pendentes;
