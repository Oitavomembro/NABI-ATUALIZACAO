...
from .customer_dto import (
    CustomerDetails, CustomerInstallment, CustomerPurchaseBehavior, CustomerReceiptCommand,
...
class FinancialActionPort(Protocol):
    def create_title(self, title_type: str, command: CreateFinancialTitleCommand, *, user: str, idempotency_key: str | None = None, operation_fingerprint: str | None = None) -> PersistedFinancialAction: ...
    def settle(self, title_type: str, command: SettleFinancialTitleCommand, *, user: str, idempotency_key: str | None = None, operation_fingerprint: str | None = None) -> PersistedFinancialAction: ...
...
class ReportReadPort(Protocol):
    ...
    def load_page(self, query: ReportQuery, *, limit: int, offset: int, actor: str): ...
