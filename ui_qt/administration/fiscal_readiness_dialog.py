...
class FiscalConfigurationDialog(QDialog):
    ...
    def __init__(self, application, parent=None) -> None:
        ...
        browse = QPushButton("Selecionar A1"); browse.clicked.connect(self._browse)
        certificate_row.addWidget(self.certificate, 1); certificate_row.addWidget(browse); form.addRow("Certificado .pfx/.p12", certificate_row)
        ...
        actions = QHBoxLayout(); actions.addStretch()
        cancel = QPushButton("Cancelar [Esc]"); save = QPushButton("Revisar e salvar")
